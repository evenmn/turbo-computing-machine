...
class Thermo:
    ...
    @staticmethod
    def time(solver):
        return solver.t * solver.integrator.dt
    ...
    @staticmethod
    def temp(solver):
        return (solver.v**2).sum() / (solver.npar * solver.ndim)
    ...
    def mse(solver):
        if solver.t == solver.t0:
            solver.r0 = solver.r
        r = solver.r + solver.n
        return ((r - solver.r0)**2).sum() / solver.npar
    """
    ...
    @staticmethod
    def acc_ratio(solver):
        return solver.acc_ratio
